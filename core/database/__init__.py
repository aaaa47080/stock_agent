...
_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "link_pi_wallet": (".user", "link_pi_wallet"),
    ...
    "create_reset_token": (".user", "create_reset_token"),
    "get_reset_token": (".user", "get_reset_token"),
    "delete_reset_token": (".user", "delete_reset_token"),
    "cleanup_expired_tokens": (".user", "cleanup_expired_tokens"),
    "MAX_LOGIN_ATTEMPTS": (".user", "MAX_LOGIN_ATTEMPTS"),
    "LOCKOUT_HOURS": (".user", "LOCKOUT_HOURS"),
    "record_login_attempt": (".user", "record_login_attempt"),
    "get_failed_attempts": (".user", "get_failed_attempts"),
    "is_account_locked": (".user", "is_account_locked"),
    "clear_login_attempts": (".user", "clear_login_attempts"),
    # chat
