...
class MockLLM:
    def invoke(self, messages):
        ...
        if "AI 助手系統" in content:
            ...
            return AIMessage(
                content='{"complexity": "simple", "intent": "chat", "topics": ["TEST"]}'
            )
            ...
            return AIMessage(
                content='{"plan": [{"step": 1, "description": "Say hello", "agent": "chat"}]}'
            )
...
async def main():
    ...
    try:
        ...
        if (
            final_resp == "Executed Hello Async World" or final_resp == "Final Answer"
        ) and len(events) > 0:
