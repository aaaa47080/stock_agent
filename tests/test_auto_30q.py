...
TEST_QUESTIONS = [
    ...
    # === 複雜問題 (6-15) - 需要多步驟思考 ===
    {
        "id": 6,
        "category": "複雜",
        "question": "比較 BTC 和 ETH 過去一週的價格走勢，哪個表現更好？",
        "expected": "多幣比較分析",
    },
    {
        "id": 7,
        "category": "複雜",
        "question": "分析 DOGE 最近有什麼重大新聞，這些新聞對價格有什麼影響？",
        "expected": "新聞+價格關聯分析",
    },
    {
        "id": 8,
        "category": "複雜",
        "question": "請幫我查詢 BTC、ETH、SOL 三種幣的技術指標（RSI、MACD），並分析哪個最適合現在買入？",
        "expected": "技術分析+比較",
    },
    {
        "id": 9,
        "category": "複雜",
        "question": "列出目前漲幅前 5 的加密貨幣，並分析它們上漲的可能原因",
        "expected": "排行榜+原因分析",
    },
    {
        "id": 10,
        "category": "複雜",
        "question": "XRP 最近的法律訴訟進展如何？這對價格有什麼影響？",
        "expected": "法律事件+價格影響",
    },
    {
        "id": 11,
        "category": "複雜",
        "question": "請分析比特幣的鏈上數據，包括活躍地址數和交易量趨勢",
        "expected": "鏈上數據分析",
    },
    {
        "id": 12,
        "category": "複雜",
        "question": "穩定幣 USDT 和 USDC 有什麼區別？哪個更安全？",
        "expected": "穩定幣比較",
    },
    {
        "id": 13,
        "category": "複雜",
        "question": "以太坊的 Gas 費用現在是多少？跟昨天相比是漲還是跌？",
        "expected": "Gas費用分析",
    },
    {
        "id": 14,
        "category": "複雜",
        "question": "分析目前加密貨幣市場的恐懼貪婪指數，這代表什麼意思？",
        "expected": "情緒指標解讀",
    },
    {
        "id": 15,
        "category": "複雜",
        "question": "DeFi 協議中目前 TVL 最高的三個是什麼？它們的特點是什麼？",
    ...
    # === 推理問題 (16-25) - 需要邏輯推導 ===
    {
        "id": 16,
        "category": "推理",
        "question": "如果美國聯準會下週宣布升息，你認為這對 BTC 價格會有什麼影響？為什麼？",
        "expected": "宏觀經濟推理",
    },
    {
        "id": 17,
        "category": "推理",
        "question": "比特幣減半事件預計在什麼時候發生？根據歷史數據，減半前後價格通常會如何變化？",
        "expected": "歷史規律推理",
    },
    {
        "id": 18,
        "category": "推理",
        "question": "如果我有 10000 美元要投資加密貨幣，你會建議我如何配置？請考慮風險和回報",
        "expected": "投資組合建議",
    },
    {
        "id": 19,
        "category": "推理",
        "question": "根據 BTC 的歷史價格數據，目前是否處於牛市還是熊市？你的判斷依據是什麼？",
        "expected": "市場週期判斷",
    },
    {
        "id": 20,
        "category": "推理",
        "question": "以太坊轉 POS 之後，對 ETH 的長期價值有什麼影響？請分析優缺點",
        "expected": "技術變革影響",
    },
    {
        "id": 21,
        "category": "推理",
        "question": "如果某個國家宣布禁止加密貨幣交易，這會對全球市場造成什麼影響？",
        "expected": "政策影響推理",
    },
    {
        "id": 22,
        "category": "推理",
        "question": "機構投資者進入加密貨幣市場，這對散戶投資者是好事還是壞事？",
        "expected": "市場結構分析",
    },
    {
        "id": 23,
        "category": "推理",
        "question": "NFT 市場目前的狀況如何？未來還有發展潛力嗎？",
        "expected": "市場趨勢預測",
    },
    {
        "id": 24,
        "category": "推理",
        "question": "Layer 2 解決方案（如 Arbitrum、Optimism）對以太坊有什麼意義？",
        "expected": "技術架構分析",
    },
    {
        "id": 25,
        "category": "推理",
        "question": "如果比特幣 ETF 獲得批准，這會如何改變加密貨幣市場？",
        "expected": "金融產品影響",
    },
    # === 深入問題 (26-30) - 多輪對話/深入探討 ===
    {
        "id": 26,
        "category": "深入",
        "question": "請詳細解釋區塊鏈的三難困境（Trilemma），以及各種項目是如何嘗試解決這個問題的",
        "expected": "技術深入探討",
    },
    {
        "id": 27,
        "category": "深入",
        "question": "分析加密貨幣的監管趨勢，全球各國的態度有什麼不同？這對行業發展有什麼影響？",
        "expected": "監管環境分析",
    },
    {
        "id": 28,
        "category": "深入",
        "question": "Web3 的核心理念是什麼？它與 Web2 有什麼根本性的區別？目前有哪些成功的 Web3 應用？",
        "expected": "Web3 概念探討",
    },
    {
        "id": 29,
        "category": "深入",
        "question": "加密貨幣市場存在哪些操縱行為？投資者應該如何識別和避免？",
        "expected": "市場操縱分析",
    },
    {
        "id": 30,
        "category": "深入",
        "question": "從技術角度分析比特幣和以太坊的根本差異，它們各自的優缺點是什麼？",
        "expected": "技術深度比較",
    },
]
