...
const WalletApp = {
    ...
    renderList(list) {
        ...
        list.forEach((tx) => {
            ...
            el.className =
                'flex items-center justify-between border-b border-white/5 py-4 hover:bg-white/5 px-3 rounded-2xl transition cursor-pointer last:border-0 group animate-fade-in-up';
    ...
    showDetail(tx) {
        if (
            typeof ForumApp !== 'undefined' &&
            typeof ForumApp.showTransactionDetail === 'function'
        ) {
